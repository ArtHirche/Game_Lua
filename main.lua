...
function checaVitoria()
    if METEOROS_ATINGIDOS >= NUMERO_METEOROS_VITORIA then
        musica_ambiente:stop()
        VENCEDOR = true
        vencedor_som:play()
    end
...
function love.draw()
    ...
    love.graphics.print("Meteoros restantes: " .. NUMERO_METEOROS_VITORIA - METEOROS_ATINGIDOS, 0, 0)
    ...
    if FIM_JOGO then
        love.graphics.draw(game_over_img, LARGURA_TELA / 2 - game_over_img:getWidth() / 2,
            ALTURA_TELA / 2 - game_over_img:getHeight() / 2)
    end
